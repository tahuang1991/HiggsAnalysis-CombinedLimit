...
combine -M AsymptoticLimits -m 400 -n GGToX0ToHHTo2B2L2Nu_NNvsHME_MCstat_M400_MuMu_ElEl_MuEl GGToX0ToHHTo2B2L2Nu_NNvsHME_MCstat_M400_MuMu_ElEl_MuEl_combine_workspace.root -s 1 -t -1 --verbose 1  &> GGToX0ToHHTo2B2L2Nu_NNvsHME_MCstat_M400_MuMu_ElEl_MuEl_signalxsec1fb_tminus1.log
popd
